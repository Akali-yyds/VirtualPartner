...
namespace VirtualPartner.Editor
{
    ...
    public sealed class LocomotionProfileEditor : UnityEditor.Editor
    {
        public override void OnInspectorGUI()
        {
            DrawDefaultInspector();

            if (GUILayout.Button("Rebuild Bone Paths From Clips"))
        ...
        private void RebuildBonePathsFromClips()
        {
            ...
            Undo.RecordObject(target, "Rebuild locomotion bone paths");
